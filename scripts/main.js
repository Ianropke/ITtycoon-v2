...
function renderActiveTask(task) {
  ...
  if (task) {
    ...
    // Hvis narrativeIntro findes, vis den
...
function cabApproval() {
  closeModal(() => {
    ...
    // Tjek hastende + let løsning => straf
    ...
    // Mulighed for at revidere, hvis man ikke valgte advanced i alt
    if (!allAdvanced) {
